...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return (
    <html lang="pt-BR">
      <body className={`${geistSans.variable} ${geistMono.variable} antialiased bg-trevo-black text-trevo-white relative`}>
        {children}
        <Footer />

        {/* BOTÃO FLUTUANTE DO WHATSAPP */}
        <a
          href="https://wa.me/5586999999999?text=Olá! Estava no site da Trevo e quero um orçamento."
          target="_blank"
